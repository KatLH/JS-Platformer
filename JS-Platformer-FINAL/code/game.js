...
Astroid.prototype.type = "astroid";
...
Blackhole.prototype.type = "blackhole"
...
var maxStep = 0.05;
var woSpeed = 0.1, woDist = 0.2;
Chest.prototype.act = function(step) {
  this.wobble += step * woSpeed;
  var woPos = Math.sin(this.wobble) * woDist;
  this.pos = this.basePos.plus(new Vector(0, woPos));
};

var wobbSpeed = 8;
var wobbDist = 0.1;
Astroid.prototype.act = function(step) {
...
var wobSpeed = 8;
var wobDist = 0.1;
Blackhole.prototype.act = function(step) {
...
Level.prototype.playerTouched = function(type, actor) {
  ...
  if (type == "lava" && this.status == null) {
    ...
    if (!this.actors.some(function(actor) {
          return actor.type == "coin" && actor.type == "chest";
          return actor.type == "coin" || actor.type == "chest"
         })) {
      this.status = "won";
      this.finishDelay = 1;
    ...
    {
      this.player.size = new Vector(0.4, 0.9);
    }
    else if (type == "blackhole")
    {
      this.player.pos = new Vector(4,5);
    }
  };
